#!/usr/bin/env node
// =====================================================
// 从 Toolify.ai (toolify.ai) 抓取工具到草稿区
// 用法:
//   node scripts/import-toolify.mjs             # 默认抓取 50 条
//   node scripts/import-toolify.mjs --limit=30  # 指定抓取数量上限
// 说明:
...
//   - 结果写入 data/tools-draft.ts 的 source='toolify' 条目,后台审核入库
// =====================================================
