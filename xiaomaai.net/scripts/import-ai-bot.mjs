#!/usr/bin/env node
// =====================================================
// 从 AI导航 (ai-bot.cn) 抓取工具到草稿区
// 用法:
//   node scripts/import-ai-bot.mjs             # 默认抓取 50 条
//   node scripts/import-ai-bot.mjs --limit=30  # 指定抓取数量上限
// 说明:
...
//   - 结果写入 data/tools-draft.ts 的 source='ai-bot' 条目,后台审核入库
// =====================================================
...
const HOME = 'https://ai-bot.cn/'
const SITEMAP_URL = 'https://ai-bot.cn/sitemap.xml'
const SOURCE = 'ai-bot'
...
// ai-bot 工具详情页路径形如 /tool/ /ai/ /detail/ /item/ /site/<slug>
