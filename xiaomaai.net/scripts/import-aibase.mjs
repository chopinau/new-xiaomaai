#!/usr/bin/env node
// =====================================================
// 从 AIBase (aibase.com) 抓取工具到草稿区
// 用法:
//   node scripts/import-aibase.mjs             # 默认抓取 50 条
//   node scripts/import-aibase.mjs --limit=30  # 指定抓取数量上限
// 说明:
...
//   - 结果写入 data/tools-draft.ts 的 source='aibase' 条目,后台审核入库
// =====================================================
...
const HOME = 'https://www.aibase.com/'
const SITEMAP_URL = 'https://www.aibase.com/sitemap.xml'
const SOURCE = 'aibase'
...
// aibase 工具详情页路径形如 /tool/ /ai/ /detail/ /item/<slug>
const TOOL_RE = /\/(tool|ai|detail|item)\/[^/?#]/i
